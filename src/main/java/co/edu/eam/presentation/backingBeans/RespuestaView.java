...
public class RespuestaView implements Serializable {
    ...
    public String action_create() {
        try {
            ...
            entity.setPresentacion((FacesUtils.checkInteger(txtId_Presentacion) != null)
                ? businessDelegatorView.getPresentacion(FacesUtils.checkInteger(
                        txtId_Presentacion)) : null);
    ...
    public String action_modifyWitDTO(Integer id, Integer nota,
        Integer id_Pregunta, Integer id_Presentacion) throws Exception {
        try {
