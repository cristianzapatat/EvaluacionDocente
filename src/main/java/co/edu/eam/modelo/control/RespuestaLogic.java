    ...
    public List<RespuestaDTO> getDataRespuesta() throws Exception {
        try {
            ...
            for (Respuesta respuestaTmp : respuesta) {
                ...
                respuestaDTO2.setNota((respuestaTmp.getNota() != null)
                    ? respuestaTmp.getNota() : null);
                respuestaDTO2.setId_Pregunta((respuestaTmp.getPregunta().getId() != null)
                    ? respuestaTmp.getPregunta().getId() : null);
                respuestaDTO2.setId_Presentacion((respuestaTmp.getPresentacion()
                                                              .getId() != null)
